...
.EXAMPLE
Set-EsfaResourceGroupTags -ResourceGroupName "sb-dev-foobar-rg" -Environment "Dev/Test" -ParentBusiness "National Careers Service" -ServiceOffering "Course Directory"
#>
